...
func TestSelect(t *testing.T) {
	for _, tt := range []struct {
		...
		},
		{
			...
			rows: []query.Row{
				{Time: 20 * Second, Series: query.Series{Name: "cpu"}, Values: []interface{}{11.96062341991843}},
				{Time: 22 * Second, Series: query.Series{Name: "cpu"}, Values: []interface{}{7.953140268154608}},
			},
		},
		{
